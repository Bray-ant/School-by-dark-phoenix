        ...
        <div className="max-w-5xl mx-auto relative">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="flex flex-wrap gap-3">
              <Link to="/chapter/stereostatics" className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#3b82f6] hover:bg-[#2563eb] text-white text-sm font-medium rounded-xl transition-colors">
                <Play className="w-4 h-4" />Start Learning<ArrowRight className="w-4 h-4" />
              </Link>
              <Link to="/practice" className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#ec4899]/15 hover:bg-[#ec4899]/25 border border-[#ec4899]/30 text-[#ec4899] text-sm font-medium rounded-xl transition-colors">
                <Dices className="w-4 h-4" />Practice Generator
              </Link>
              <Link to="/exercises" className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/5 hover:bg-white/10 text-[#f6f6f6] text-sm font-medium rounded-xl border border-white/10 transition-colors">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid gap-4">
            {chapterList.map((chapter, index) => {
              ...
              return (
                <motion.div key={chapter.id} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: index * 0.1 }}>
                  <Link to={`/chapter/${chapter.id}`} className="group block relative overflow-hidden rounded-2xl border border-white/10 bg-[#111111]/50 hover:border-white/20 transition-all duration-300">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.4 }}>
              <Link to="/exercises" className="group block relative overflow-hidden rounded-2xl border border-[#8b5cf6]/20 bg-[#111111]/50 hover:border-[#8b5cf6]/40 transition-all duration-300">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.5 }}>
              <Link to="/practice" className="group block relative overflow-hidden rounded-2xl border border-[#ec4899]/20 bg-[#111111]/50 hover:border-[#ec4899]/40 transition-all duration-300">
          ...
          <div className="grid gap-3 mb-8">
            {dcChapterList.map((ch, index) => (
              <motion.div key={ch.id} initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.05 }}>
                <Link to={`/dc-circuit/${ch.id}`} className="group flex items-center gap-4 p-4 rounded-2xl glass-panel hover:border-white/20 transition-all">
        ...
        <div className="max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-8">
            <div className="flex items-center justify-between">
              ...
              <Link to="/math" className="hidden sm:inline-flex items-center gap-2 px-4 py-2 bg-[#f59e0b]/10 hover:bg-[#f59e0b]/20 border border-[#f59e0b]/30 text-[#f59e0b] text-xs font-medium rounded-xl transition-all">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
            {mathModules.map((mod, index) => (
              <motion.div key={mod.id} initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.08 }}>
                <Link to="/math" className="group block rounded-2xl border border-white/10 bg-[#111111]/50 hover:border-white/20 transition-all p-5">
          ...
          <div className="sm:hidden text-center">
            <Link to="/math" className="inline-flex items-center gap-2 px-4 py-2 bg-[#f59e0b]/10 border border-[#f59e0b]/30 text-[#f59e0b] text-xs font-medium rounded-xl transition-all">
        ...
        <div className="max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-8">
            <div className="flex items-center justify-between">
              ...
              <Link to="/em" className="hidden sm:inline-flex items-center gap-2 px-4 py-2 bg-[#00d4ff]/10 hover:bg-[#00d4ff]/20 border border-[#00d4ff]/30 text-[#00d4ff] text-xs font-medium rounded-xl transition-all">
          ...
          <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <Link to="/em" className="group block rounded-2xl border border-[#00d4ff]/15 bg-[#111111]/50 hover:border-[#00d4ff]/30 transition-all p-6">
        ...
        <div className="max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-8">
            <div className="flex items-center justify-between">
              ...
              <Link to="/games" className="hidden sm:inline-flex items-center gap-2 px-4 py-2 bg-[#ec4899]/10 hover:bg-[#ec4899]/20 border border-[#ec4899]/30 text-[#ec4899] text-xs font-medium rounded-xl transition-all">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              ...
              <motion.div key={game.id} initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.06 }}>
                <Link to={`/games/${game.id}`} className="group block rounded-2xl border border-white/10 bg-[#111118]/50 hover:border-white/20 transition-all p-4">
