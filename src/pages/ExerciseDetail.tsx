    ...
    <div className="min-h-screen py-8 px-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-2 mb-6 text-xs text-[#737373]">
          ...
          <span>/</span>
          <Link to="/exercises" className="hover:text-white">Exercises</Link>
          <span>/</span>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <Link to="/exercises" className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 hover:bg-white/10 text-xs transition-colors">
