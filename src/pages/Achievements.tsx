    ...
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      {!isAuthenticated && (
        <div className="mt-6 glass-panel rounded-xl p-4 text-center">
          ...
          <Link to="/login" className="inline-flex items-center gap-1.5 mt-2 px-4 py-2 rounded-lg bg-[#3b82f6]/15 border border-[#3b82f6]/30 text-xs text-[#3b82f6] hover:bg-[#3b82f6]/25 transition-all">
            Sign In to Sync
          </Link>
        </div>
      )}
