    ...
    return (
      <div className="min-h-screen pt-20 pb-16 px-6 flex items-center justify-center">
        <div className="max-w-sm w-full">
          <button onClick={() => router.push('/')} className="flex items-center gap-1.5 text-[10px] text-[#737373] hover:text-white mb-4 transition-colors">
...
export default withClientOnly(AdminAnalytics);
