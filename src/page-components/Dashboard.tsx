      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="glass-panel rounded-2xl p-5">
            ...
            <div className="space-y-2">
              <Link href="/achievements" className="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-colors group">
              ...
              <Link href="/study-timer" className="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-colors group">
              ...
              <Link href="/ai-tutor" className="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-colors group">
              ...
              <Link href="/dc-lab" className="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-colors group">
              ...
              {user?.role === 'admin' && (
                <>
                  <Link href="/admin/users" className="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-colors group">
              ...
              {user?.email === 'hohenheimvon01@gmail.com' && (
                <Link href="/admin/activity" className="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-colors group">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="glass-panel rounded-2xl p-5">
            ...
            <div className="space-y-4">
              {chapterList.map((chapter) => {
                ...
                return (
                  <Link key={chapter.id} href={`/chapter/${chapter.id}`} className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/5 transition-colors group">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="glass-panel rounded-2xl p-5">
              ...
              <div className="space-y-2">
                {quizzes.map((quiz) => {
                  ...
                  if (!ch) return null;
                  return (
                    <Link key={quiz.id} href={`/chapter/${ch.id}`} className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/5 transition-colors group">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="glass-panel rounded-2xl p-5">
          ...
          <div className="flex flex-wrap gap-3">
            {chapterList.map(ch => (
              <Link key={ch.id} href={`/chapter/${ch.id}`} className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm transition-all" style={{ backgroundColor: `${ch.color}10`, border: `1px solid ${ch.color}20`, color: ch.color }}>
                {chapterIcons[ch.id]}
                <span>{ch.title}</span>
