      ...
      <div className="max-w-5xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          <div className="flex items-center gap-2 mb-4 text-xs text-[#737373]">
            <Link href="/" className="hover:text-white flex items-center gap-1"><ChevronLeft className="w-3 h-3" />Home</Link>
          </div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }} className="mt-8 glass-panel rounded-2xl p-5 flex items-center justify-between">
          ...
          <Link href="/dc-circuit/dc-fundamentals" className="flex items-center gap-2 px-4 py-2 bg-[#10b981] hover:bg-[#059669] text-white text-xs font-medium rounded-xl transition-colors">
